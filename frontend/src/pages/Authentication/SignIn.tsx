      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Admin dashboard to handle Clients, Suppliers, Orders, Inventory and Items
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            {error &&
              <div className="fixed z-99999 top-2 flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
                <div
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Only admin accounts allowed</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to POW Store
              </h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <a className="text-primary" href="mailto:dev.cesar1004@gmail.com">Contact an administrator</a>
                  </p>
                </div>
              </form>
            </div>
